Pour comprendre comment se battre dans ce JDR, il faut juste se dire qu’un combat est une suite [[Realiser une action|d’action à réaliser]].

Donner un coup, suivant l’action du PJ, se basera généralement sur la stat de force, de dextérité ou d’efficacité magique.

# Le calcul des dommages

Il n’y a pas de jauge de point de vie dans ce JDR, en revanche la fatigue, le nombre de blessure ainsi que leur gravité seront évidemment pris en compte pour déterminer l’état du PJ.
Quelques plaies n’auront pas d’effet négatif en revanche le cumule fera que ça peut être considéré comme une blessure handicapante. Dans un exemple plus extrême, le PJ aura beau être en pleine forme, si une hache s’abat sur sa nuque et que tout est réuni pour faire le maximum de dommage, PJ ou pas, c’est la mort.
...
L’effet de surprise, les blessures, les compétences, etc.. sont évidement des paramètres pouvant influer sur l’ordre.

## Hors tour

Si ce n’est pas à vous de jouer, vous avez quand même la possibilité d'interagir dans deux situations : 
